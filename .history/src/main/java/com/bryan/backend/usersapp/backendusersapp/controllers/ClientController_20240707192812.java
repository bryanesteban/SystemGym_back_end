...
public class ClientController {
    ...
    public ResponseEntity<?> updateClient(@Valid @RequestBody Client client, BindingResult result, @PathVariable String identefication )
    {
        if(result.hasErrors()){
            return validation(result);
        }
        Optional<ClientDTO> o = clientService.update(client, identefication);
        if(o.isPresent()){
